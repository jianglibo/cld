...
import com.mymock.db.sys.enums.ProcesslistTrxAutocommit;
import com.mymock.db.sys.enums.ProcesslistTrxState;
import com.mymock.db.sys.tables.records.ProcesslistRecord;
...
public class Processlist extends TableImpl<ProcesslistRecord> {
	...
	private static final long serialVersionUID = -320124649;
	 ...
	 */
	public final TableField<ProcesslistRecord, ProcesslistTrxState> TRX_STATE = createField("trx_state", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.mymock.db.sys.enums.ProcesslistTrxState.class), this, "");

	/**
	 * The column <code>sys.processlist.trx_autocommit</code>.
	 */
	public final TableField<ProcesslistRecord, ProcesslistTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.mymock.db.sys.enums.ProcesslistTrxAutocommit.class), this, "");
