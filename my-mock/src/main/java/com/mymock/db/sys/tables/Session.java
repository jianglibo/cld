...
import com.mymock.db.sys.enums.SessionTrxAutocommit;
import com.mymock.db.sys.enums.SessionTrxState;
import com.mymock.db.sys.tables.records.SessionRecord;
...
public class Session extends TableImpl<SessionRecord> {
	...
	private static final long serialVersionUID = -1823770164;
	 ...
	 */
	public final TableField<SessionRecord, SessionTrxState> TRX_STATE = createField("trx_state", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.mymock.db.sys.enums.SessionTrxState.class), this, "");

	/**
	 * The column <code>sys.session.trx_autocommit</code>.
	 */
	public final TableField<SessionRecord, SessionTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.mymock.db.sys.enums.SessionTrxAutocommit.class), this, "");
