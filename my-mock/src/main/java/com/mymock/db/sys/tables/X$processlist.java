...
import com.mymock.db.sys.enums.X$processlistTrxAutocommit;
import com.mymock.db.sys.enums.X$processlistTrxState;
import com.mymock.db.sys.tables.records.X$processlistRecord;
...
public class X$processlist extends TableImpl<X$processlistRecord> {
	...
	private static final long serialVersionUID = 161761018;
	 ...
	 */
	public final TableField<X$processlistRecord, X$processlistTrxState> TRX_STATE = createField("trx_state", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.mymock.db.sys.enums.X$processlistTrxState.class), this, "");

	/**
	 * The column <code>sys.x$processlist.trx_autocommit</code>.
	 */
	public final TableField<X$processlistRecord, X$processlistTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.mymock.db.sys.enums.X$processlistTrxAutocommit.class), this, "");
