...
import com.mymock.db.mysql.enums.ProcsPrivRoutineType;
...
public class ProcsPriv extends TableImpl<ProcsPrivRecord> {
	...
	private static final long serialVersionUID = -1700359284;
	 ...
	 */
	public final TableField<ProcsPrivRecord, ProcsPrivRoutineType> ROUTINE_TYPE = createField("Routine_type", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.mymock.db.mysql.enums.ProcsPrivRoutineType.class), this, "");
