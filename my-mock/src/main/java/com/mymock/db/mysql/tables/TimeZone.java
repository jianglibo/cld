...
import com.mymock.db.mysql.enums.TimeZoneUseLeapSeconds;
...
public class TimeZone extends TableImpl<TimeZoneRecord> {
	...
	private static final long serialVersionUID = -1534084492;
	 ...
	 */
	public final TableField<TimeZoneRecord, TimeZoneUseLeapSeconds> USE_LEAP_SECONDS = createField("Use_leap_seconds", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.mymock.db.mysql.enums.TimeZoneUseLeapSeconds.class), this, "");
