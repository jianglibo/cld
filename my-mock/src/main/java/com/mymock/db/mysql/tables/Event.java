...
import com.mymock.db.mysql.enums.EventIntervalField;
import com.mymock.db.mysql.enums.EventOnCompletion;
import com.mymock.db.mysql.enums.EventStatus;
...
public class Event extends TableImpl<EventRecord> {
	...
	private static final long serialVersionUID = -1918230343;
	 ...
	 */
	public final TableField<EventRecord, EventIntervalField> INTERVAL_FIELD = createField("interval_field", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.mymock.db.mysql.enums.EventIntervalField.class), this, "");
	 ...
	 */
	public final TableField<EventRecord, EventStatus> STATUS = createField("status", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.mymock.db.mysql.enums.EventStatus.class), this, "");

	/**
	 * The column <code>mysql.event.on_completion</code>.
	 */
	public final TableField<EventRecord, EventOnCompletion> ON_COMPLETION = createField("on_completion", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.mymock.db.mysql.enums.EventOnCompletion.class), this, "");
