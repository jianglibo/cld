...
import com.mymock.db.mysql.enums.FuncType;
...
public class Func extends TableImpl<FuncRecord> {
	...
	private static final long serialVersionUID = 276504238;
	 ...
	 */
	public final TableField<FuncRecord, FuncType> TYPE = createField("type", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.mymock.db.mysql.enums.FuncType.class), this, "");
