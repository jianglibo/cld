...
import com.mymock.db.performance_schema.enums.SetupInstrumentsEnabled;
import com.mymock.db.performance_schema.enums.SetupInstrumentsTimed;
import com.mymock.db.performance_schema.tables.records.SetupInstrumentsRecord;
...
public class SetupInstruments extends TableImpl<SetupInstrumentsRecord> {
	...
	private static final long serialVersionUID = 736985905;
	 ...
	 */
	public final TableField<SetupInstrumentsRecord, SetupInstrumentsEnabled> ENABLED = createField("ENABLED", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.mymock.db.performance_schema.enums.SetupInstrumentsEnabled.class), this, "");

	/**
	 * The column <code>performance_schema.setup_instruments.TIMED</code>.
	 */
	public final TableField<SetupInstrumentsRecord, SetupInstrumentsTimed> TIMED = createField("TIMED", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.mymock.db.performance_schema.enums.SetupInstrumentsTimed.class), this, "");
