...
import com.mymock.db.performance_schema.enums.SetupConsumersEnabled;
import com.mymock.db.performance_schema.tables.records.SetupConsumersRecord;
...
public class SetupConsumers extends TableImpl<SetupConsumersRecord> {
	...
	private static final long serialVersionUID = 1766126843;
	 ...
	 */
	public final TableField<SetupConsumersRecord, SetupConsumersEnabled> ENABLED = createField("ENABLED", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.mymock.db.performance_schema.enums.SetupConsumersEnabled.class), this, "");
