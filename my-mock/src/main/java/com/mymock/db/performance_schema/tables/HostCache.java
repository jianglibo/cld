...
import com.mymock.db.performance_schema.enums.HostCacheHostValidated;
import com.mymock.db.performance_schema.tables.records.HostCacheRecord;
...
public class HostCache extends TableImpl<HostCacheRecord> {
	...
	private static final long serialVersionUID = -1928428471;
	 ...
	 */
	public final TableField<HostCacheRecord, HostCacheHostValidated> HOST_VALIDATED = createField("HOST_VALIDATED", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.mymock.db.performance_schema.enums.HostCacheHostValidated.class), this, "");
