...
import org.jooq.example.gradle.db.performance_schema.enums.SocketInstancesState;
import org.jooq.example.gradle.db.performance_schema.tables.records.SocketInstancesRecord;
...
public class SocketInstances extends TableImpl<SocketInstancesRecord> {
	...
	private static final long serialVersionUID = -283160655;
	 ...
	 */
	public final TableField<SocketInstancesRecord, SocketInstancesState> STATE = createField("STATE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(org.jooq.example.gradle.db.performance_schema.enums.SocketInstancesState.class), this, "");
