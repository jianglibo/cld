...
import org.jooq.example.gradle.db.performance_schema.tables.records.HostCacheRecord;
...
public class HostCache extends TableImpl<HostCacheRecord> {
	...
	private static final long serialVersionUID = -1999188010;
	 ...
	 */
	public final TableField<HostCacheRecord, HostCacheHostValidated> HOST_VALIDATED = createField("HOST_VALIDATED", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(org.jooq.example.gradle.db.performance_schema.enums.HostCacheHostValidated.class), this, "");
