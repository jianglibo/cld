...
import org.jooq.example.gradle.db.performance_schema.enums.EventsStagesCurrentNestingEventType;
import org.jooq.example.gradle.db.performance_schema.tables.records.EventsStagesCurrentRecord;
...
public class EventsStagesCurrent extends TableImpl<EventsStagesCurrentRecord> {
	...
	private static final long serialVersionUID = -1076383244;
	 ...
	 */
	public final TableField<EventsStagesCurrentRecord, EventsStagesCurrentNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(org.jooq.example.gradle.db.performance_schema.enums.EventsStagesCurrentNestingEventType.class), this, "");
