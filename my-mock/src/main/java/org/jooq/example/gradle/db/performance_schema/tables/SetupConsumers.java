...
import org.jooq.example.gradle.db.performance_schema.tables.records.SetupConsumersRecord;
...
public class SetupConsumers extends TableImpl<SetupConsumersRecord> {
	...
	private static final long serialVersionUID = -1188262786;
	 ...
	 */
	public final TableField<SetupConsumersRecord, SetupConsumersEnabled> ENABLED = createField("ENABLED", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(org.jooq.example.gradle.db.performance_schema.enums.SetupConsumersEnabled.class), this, "");
