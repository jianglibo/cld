...
import org.jooq.example.gradle.db.sys.enums.SessionTrxAutocommit;
import org.jooq.example.gradle.db.sys.enums.SessionTrxState;
import org.jooq.example.gradle.db.sys.tables.records.SessionRecord;
...
public class Session extends TableImpl<SessionRecord> {
	...
	private static final long serialVersionUID = 1799999451;
	 ...
	 */
	public final TableField<SessionRecord, SessionTrxState> TRX_STATE = createField("trx_state", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(org.jooq.example.gradle.db.sys.enums.SessionTrxState.class), this, "");

	/**
	 * The column <code>sys.session.trx_autocommit</code>.
	 */
	public final TableField<SessionRecord, SessionTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(org.jooq.example.gradle.db.sys.enums.SessionTrxAutocommit.class), this, "");
