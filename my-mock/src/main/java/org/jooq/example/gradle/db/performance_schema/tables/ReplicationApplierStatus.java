...
import org.jooq.example.gradle.db.performance_schema.tables.records.ReplicationApplierStatusRecord;
...
public class ReplicationApplierStatus extends TableImpl<ReplicationApplierStatusRecord> {
	...
	private static final long serialVersionUID = 339194960;
	 ...
	 */
	public final TableField<ReplicationApplierStatusRecord, ReplicationApplierStatusServiceState> SERVICE_STATE = createField("SERVICE_STATE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(org.jooq.example.gradle.db.performance_schema.enums.ReplicationApplierStatusServiceState.class), this, "");
