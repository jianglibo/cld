...
import org.jooq.example.gradle.db.performance_schema.enums.EventsWaitsCurrentNestingEventType;
import org.jooq.example.gradle.db.performance_schema.tables.records.EventsWaitsCurrentRecord;
...
public class EventsWaitsCurrent extends TableImpl<EventsWaitsCurrentRecord> {
	...
	private static final long serialVersionUID = 1692488881;
	 ...
	 */
	public final TableField<EventsWaitsCurrentRecord, EventsWaitsCurrentNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(org.jooq.example.gradle.db.performance_schema.enums.EventsWaitsCurrentNestingEventType.class), this, "");
