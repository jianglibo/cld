...
import org.jooq.example.gradle.db.performance_schema.enums.EventsWaitsHistoryNestingEventType;
import org.jooq.example.gradle.db.performance_schema.tables.records.EventsWaitsHistoryRecord;
...
public class EventsWaitsHistory extends TableImpl<EventsWaitsHistoryRecord> {
	...
	private static final long serialVersionUID = 1735358319;
	 ...
	 */
	public final TableField<EventsWaitsHistoryRecord, EventsWaitsHistoryNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(org.jooq.example.gradle.db.performance_schema.enums.EventsWaitsHistoryNestingEventType.class), this, "");
