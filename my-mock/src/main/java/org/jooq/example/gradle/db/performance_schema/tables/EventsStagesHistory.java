...
import org.jooq.example.gradle.db.performance_schema.enums.EventsStagesHistoryNestingEventType;
import org.jooq.example.gradle.db.performance_schema.tables.records.EventsStagesHistoryRecord;
...
public class EventsStagesHistory extends TableImpl<EventsStagesHistoryRecord> {
	...
	private static final long serialVersionUID = 1997113878;
	 ...
	 */
	public final TableField<EventsStagesHistoryRecord, EventsStagesHistoryNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(org.jooq.example.gradle.db.performance_schema.enums.EventsStagesHistoryNestingEventType.class), this, "");
