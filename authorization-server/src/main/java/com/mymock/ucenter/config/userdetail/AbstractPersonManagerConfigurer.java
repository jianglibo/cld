...
public abstract class AbstractPersonManagerConfigurer<B extends ProviderManagerBuilder<B>, C extends AbstractPersonManagerConfigurer<B,C>> extends UserDetailsServiceConfigurer<B, C, PersonManager> {
    ...
    public class InternalPersonVoBuilder {
        ...
        public InternalPersonVoBuilder displayName(String displayName) {
            Assert.notNull(displayName, "username cannot be null");
       ...
       public InternalPersonVoBuilder disabled(boolean disabled) {
        ...
        private PersonVo build() {
            return new PersonVo(name, displayName,email, mobile, password, !disabled, !accountExpired,
