...
public class ToHttpServletResponse extends BytesProcessor {
    
    private HttpServletResponse resp;
    
    private OutputStream os;

    public ToHttpServletResponse(OriginUrl ou, HttpServletResponse resp, CompositeEnv env) throws BytesProcessorException, IOException {
        super(ou, env);
        this.resp = resp;
